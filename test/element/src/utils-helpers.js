    ...
    describe("helpers", () => {
        describe("deepClone", () => {
            it("basic", () => {
                ...
                expect(deepClone({ a: 1, b: 2, c: 3 })).to.be.eql({
                    a: 1,
                    b: 2,
                    c: 3,
                });
            ...
            it("deep", () => {
                expect(deepClone({ a: { b: { c: 123 } } })).to.be.eql({
                    a: { b: { c: 123 } },
                });
            });
        });
        ...
        describe("has", () => {
            ...
            it("deep array", () => {
                ...
                expect(has([1, { a: [{ b: 123 }] }], [1, "a", 0, "b"])).to.be
                    .true;
            });
        });
        ...
        describe("get", () => {
            ...
            it("deep array", () => {
                ...
                expect(
                    get([1, { a: [{ b: 123 }] }], [1, "a", 0, "b"])
                ).to.be.eql(123);
                expect(
                    get([1, { a: [{ b: 123 }] }], [1, "a", 0, "c"], 456)
                ).to.be.eql(456);
            });
        });
